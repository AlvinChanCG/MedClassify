...
class ResNetAP(nn.Module):
    def __init__(self, args):
        ...
        Args:
            args:
                Default using depth, num_classes, width and norm_type here.
                net_depth (int): depth of the ResNet, default 18.
                nclasses (int): number of classes.
                width_factor (float): multiply to 64 as a width factor to generate inplanes, default 1.0.
                norm_type (str): type of normalization, default 'batch'.
        """
        ...
        nch = args.datachannel
        size = args.im_size[0]

        self.norm_type = args.norm_type

        if (0 < size and size <= 64):
            self.net_size = 'small'
        ...
        if self.net_size == 'small':
            ...
            self.layer0 = IntroBlock(self.net_size, self.inplanes, self.norm_type, nch=nch)
            nc = self.inplanes
